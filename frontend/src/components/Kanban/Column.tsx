  ...
  return (
    <>
      ...
      >
        {/* HEADER DA COLUNA */}
        {!isConfirmingDelete ? (
          <div {...attributes} {...listeners} className="p-4 cursor-grab flex items-center justify-between group select-none flex-shrink-0">
              <div className="flex gap-3 items-center flex-1 min-w-0">
                  <h3 className="truncate text-base font-extrabold text-gray-700 dark:text-gray-200 tracking-tight">{column.title}</h3>
